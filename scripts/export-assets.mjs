...
const manifest={version:1,artStatus:'original-code-generated-placeholder',source:'src/game/art/Textures.ts',referenceInventory:'../../references/inventory.json',pixelArt:true,smoothing:false,textures:[],atlases:[],pendingGroups:['ui','title','mobile','ending']};
