...
Owner photo refinement (2026-09-09): **Snowball is the owner's Siamese cat, and her own photos define the markings.** All seven photos were inspected; photos 4 and 7 anchor the face and eyes, and photos 3 and 5 inform the body. The 44 frames now use ivory/cream fur, pale gray-beige face shading, narrow forehead/cheek markings, a gray nose bridge, white muzzle, pink inner ears, pale round paws and large ice-blue eyes. The prior generic dark-mask correction was too dark for Snowball. See `SNOWBALL_IDENTITY.md` for the reference roles and unresolved tail detail. Source photos remain outside the repository.

The game, title, HUD and dialogue/result portraits share this corrected sheet. The sleeping neighbor has its own drawing and retains its separate appearance. The manifest version is included in image URLs so refreshed games request the corrected artwork instead of a cached prior sheet.
